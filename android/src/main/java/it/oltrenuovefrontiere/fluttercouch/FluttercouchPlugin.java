...
public class FluttercouchPlugin implements CBManagerDelegate {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        final EventChannel replicationEventChannel = new EventChannel(registrar.messenger(),
        ...
        final EventChannel queryEventChannel = new EventChannel(registrar.messenger(),
                "it.oltrenuovefrontiere.fluttercouch/queryEventChannel", JSONMethodCodec.INSTANCE);
        ...
        public void onMethodCall(MethodCall call, final Result result) {
            ...
            case ("storeQuery"):
                ...
                if (queryFromJson == null) {
                    ...
                    if (queryFromJson != null) {
                        ListenerToken mListenerToken = queryFromJson.addChangeListener(AsyncTask.THREAD_POOL_EXECUTOR,
                                new QueryChangeListener() {
                                    @Override
